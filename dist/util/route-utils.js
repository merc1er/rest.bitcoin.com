...
var RouteUtils = /** @class */ (function () {
    ...
    // or not.
    RouteUtils.prototype.validateArraySize = function (req, array) {
        var FREEMIUM_INPUT_SIZE = 20;
        var PRO_INPUT_SIZE = 20;
        if (req.locals && req.locals.proLimit) {
            if (array.length <= PRO_INPUT_SIZE)
                return true;
        }
    ...
    RouteUtils.prototype.getAxiosOptions = function () {
        return {
            method: "post",
    ...
    // trest.bitcoin.com.
    RouteUtils.prototype.validateNetwork = function (addr) {
        try {
    ...
    RouteUtils.prototype.decodeError = function (err) {
        try {
